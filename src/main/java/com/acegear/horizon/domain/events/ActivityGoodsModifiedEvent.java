 ...
 */
//活动项目修改
public class ActivityGoodsModifiedEvent extends BaseEvent {
    ...
    public ActivityGoodsModifiedEvent(Long activityId, Long activityStageId, Long activityGroupId,
    ...
    public ActivityGoodsModifiedEvent() {
    }
    ...
    public String routingKey() {
        return "horizon.domain.activity.goods.update";
    }
}

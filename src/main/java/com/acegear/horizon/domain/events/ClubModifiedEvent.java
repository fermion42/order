...
/**
 * Created by guoweike on 17/7/4.
 */
public class ClubModifiedEvent extends BaseEvent {
    ...
    public ClubModifiedEvent(Long clubId, Long userId, String name, String address, String phone,

 ...
 */
public class ActivityCreateBackgroundEvent  extends BaseEvent {
    private ClubManageEventBase eventBase; // 活动基础信息
    private List<ClubManageEventStage> eventStages; // 阶段列表

    public ActivityCreateBackgroundEvent() {
    }

    public ActivityCreateBackgroundEvent(ClubManageEventBase eventBase, List<ClubManageEventStage> eventStages) {

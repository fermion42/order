...
public class ActivityModifiedEvent extends BaseEvent {
    ...
    public ActivityModifiedEvent(Long activityId, Long ownerId, String name, Long startAt, Long endAt, String cover, String logo, String clubName,boolean payAudit) {
        super();
